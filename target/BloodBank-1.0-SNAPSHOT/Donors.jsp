...
<html>
    ...
    <!-- Navbar 2 End -->
        ...
        Donor First Name : <input type="text"  value="" id="donor_first_name" />
        <br>           
        Donor Last Name : <input type="text" value="" id="donor_last_name" />
        <br>
        ...
        <br>
        <button onclick="addDonor()" id="submit_btn" class="button-6">Submit</button>
        <br>
        <button onclick="loadDonorData()" id="get_btn" class="button-6">Get All</button>
        <br>
        <button onclick="getDonor()" id="get_btn" class="button-6">Get Donor</button>
        <br>
        <button onclick="updateDonor()" id="get_btn" class="button-6">Update Donor</button>
        </div>
        <br>
        <br>
        ...
        <table border="10" style="border: 2px solid black;">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Donor First Name</th>
                    <th style="text-align:center">Donor Last Name</th>
