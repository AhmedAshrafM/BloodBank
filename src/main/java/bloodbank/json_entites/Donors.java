...
public class Donors  implements java.io.Serializable {
    ...
    public Donors(Staff staff, String firstName, String lastName, String gender, String address, String bloodType, String natId, Date dateOfBirth, String primaryNumber, String secondaryNumber, Set diseaseses, Set bloodTransactionses) {
       this.staff = staff;
       this.firstName = firstName;
       this.lastName = lastName;
       this.gender = gender;
