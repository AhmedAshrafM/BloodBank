 ...
 * @author Ahmed
 */
public class getDonors extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Donors_DAO Donors_dao = new Donors_DAO();
            List<Donors> Donors_List = Donors_dao.GetAllDonors();
            ...
            for (Donors d : Donors_List) {
                ...
                record.setDonorId(d.getDonorId());
